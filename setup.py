...
setup(name='mr.developer',
      ...
      url='https://h3@github.com/h3/duke-deploy-django.git',
      license='BSD',
      packages=['duke', 'duke.deploydjango'],
      package_dir = {'': 'src'},
      namespace_packages=['duke.deploydjango'],
     ...
     #test_suite='dukedeploydjango.tests',
      entry_points="""
      [console_scripts]
      develop = duke.deploydjango.deploy:deploy
      [zc.buildout.extension]
      default = duke.deploydjango.extension:extension
      """,
      **extra
      )
